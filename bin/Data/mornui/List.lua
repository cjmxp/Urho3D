...
<Box name="render" x="0" y="0" width="100" height="100">
  <Clip skin="Textures/image.png" index="0" clipX="2" width="200" height="100" name="img"/>
</Box>
<VScrollBar skin="Textures/vscroll.png" x="448" width="17" height="408" name="scrollBar"/>
</List>]])
List:InitAttribute()
List:InitChilds()
return List